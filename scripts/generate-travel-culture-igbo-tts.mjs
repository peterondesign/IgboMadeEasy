#!/usr/bin/env node
// Generates Igbo TTS audio for the "Travel & Culture" lesson
// Run: npm run tts:travel-culture
...
const IGBO_TARGETS = {
  "i-am-travelling": "Ana m eje njem",
  "where-is-the-market": "Ebee ka ahịa dị",
  "i-am-going-to-town": "Ana m aga obodo",
  "we-will-meet-at-village-square": "Anyi ga-ezukọ n'ama",
  "my-father-is-at-family-compound": "Nna m nọ n'obi",
  "i-will-visit-my-sibling": "Aga m eleta nwanne m",
  "the-celebration-was-beautiful": "Emume ahụ mara mma",
  "i-will-visit-my-family": "Aga m eleta ezinụlọ m",
  "i-am-going-to-my-fathers-hometown": "Ana m aga obodo nna m",
};

const EXAMPLE_TARGETS = {
  "i-am-travelling-example": "Aga m eje njem echi",
  "where-is-the-market-example": "Ebee ka ụlọ nkwari akụ dị",
  "i-am-going-to-town-example": "Aga m Lagos echi",
  "we-will-meet-at-village-square-example": "Anyi ga-ezukọ n'obi",
  "my-father-is-at-family-compound-example": "Nne m nọ n'ụlọ",
  "i-will-visit-my-sibling-example": "Aga m eleta ezinụlọ m",
  "the-celebration-was-beautiful-example": "Emume ahụ dị mma",
  "i-will-visit-my-family-example": "Obi dị m ụtọ ịhụ gị",
  "i-am-going-to-my-fathers-hometown-example": "Maka emume ezinụlọ",
};
...
async function main() {
  ...
  console.log(
    `\nFound ${total} travel & culture audio clips (${pendingTargets.length} to generate, ${total - pendingTargets.length} existing).`
  );

  if (pendingTargets.length === 0) {
    console.log("Nothing to do. All travel & culture audio files already exist.");
    return;
  }
  ...
  console.log("\n✓ All travel & culture audio files generated successfully.");
}
